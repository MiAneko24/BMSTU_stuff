...
QT_MOC_LITERAL(1, 6, 7), // "prepare"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 9), // "freeCabin"
QT_MOC_LITERAL(4, 25, 11), // "reachTarget"
QT_MOC_LITERAL(5, 37, 5), // "floor"
QT_MOC_LITERAL(6, 43, 9), // "openDoors"
QT_MOC_LITERAL(7, 53, 4), // "stop"
QT_MOC_LITERAL(8, 58, 4), // "move"
QT_MOC_LITERAL(9, 63, 5), // "stand"
QT_MOC_LITERAL(10, 69, 4), // "call"
QT_MOC_LITERAL(11, 74, 2), // "fl"
QT_MOC_LITERAL(12, 77, 10) // "freedCabin"

    },
    "Cabin\0prepare\0\0freeCabin\0reachTarget\0"
    "floor\0openDoors\0stop\0move\0stand\0call\0"
    "fl\0freedCabin"
};
...
void Cabin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->freeCabin(); break;
        case 2: _t->reachTarget((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->openDoors(); break;
        case 4: _t->stop(); break;
        case 5: _t->move(); break;
        case 6: _t->stand(); break;
        case 7: _t->call((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 8: _t->freedCabin(); break;
        default: ;
        }
        ...
        {
            using _t = void (Cabin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cabin::prepare)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Cabin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cabin::freeCabin)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cabin::reachTarget)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Cabin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cabin::openDoors)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void Cabin::reachTarget(int _t1)
{
