...
QT_MOC_LITERAL(1, 9, 9), // "setTarget"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Elevator\0setTarget\0"
};
...
void Elevator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setTarget((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Elevator::setTarget)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Elevator::setTarget(int _t1)
{
